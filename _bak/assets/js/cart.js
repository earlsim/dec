$(function () {
    ...
    $(".cart .delete").click(function () {
        ...
        var row = $(this).closest('.js-cart-item');
    ...
    $('.js-cart-item-qty-dec').click(function () {
      $(this).closest('.js-cart-item-qty').find('.js-cart-item-qty-input').val(function (i, oldval) { return --oldval || 1; });
      $(".js-cart-item-qty-input").trigger('change');
    });

    $('.js-cart-item-qty-inc').click(function () {
      var $itemQty = $(this).closest('.js-cart-item-qty');
      $itemQty.find('.js-cart-item-qty-input').val(function (i, oldval) {
        var max = $itemQty.find('.js-cart-item-qty-max:hidden').val();
    ...
    $(".js-cart-item-qty-input").change(function () {
        var that = $(this);

        $(this).val(function (i, val) {
          return Math.abs(parseInt(val)) || 1;
        });

        if (that.val() > 0) {
            var row = that.closest('.js-cart-item');
            if (that.val()) {
                $('.js-wait-wrapper').addClass('is-active');
